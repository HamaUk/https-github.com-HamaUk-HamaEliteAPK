...
import com.optic.tv.databinding.ActivityDashboardBinding
import com.optic.tv.models.PlaylistData
import com.optic.tv.utils.AppStatus
...
class DashboardActivity : BaseThemedAppCompatActivity() {
    ...
    private fun setupClickListeners() {
        ...
        binding.cardQuran.setOnClickListener {
            startActivity(Intent(this, com.optic.tv.quran.QuranActivity::class.java))
        }
